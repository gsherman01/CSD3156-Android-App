...
/**
 * Listing Chats Screen - Shows all chat rooms for a specific listing.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ListingChatsScreen(
    listingId: String,
    listingTitle: String,
    ...
    val viewModel: ListingChatsViewModel = viewModel(
        factory = object : ViewModelProvider.Factory {
            @Suppress("UNCHECKED_CAST")
            override fun <T : ViewModel> create(modelClass: Class<T>): T {
                return ListingChatsViewModel(listingId, chatRepository, authRepository) as T
            }
        }
    )
            ...
            uiState.chatRooms.isEmpty() -> {
                Box(
                    ...
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        ...
                        Text(
                            text = "Buyers will appear here when they message you",
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
                    }
                ...
                LazyColumn(
                    ...
                    items(uiState.chatRooms) { chatRoomWithUnread ->
                        ...
                        // Determine the other user (buyer)
